...
public class AjaxController {
	...
	// @Autowired : 등록된 Bean 중 같은 타입 또는 상속관계 Bean을 
	// 해달 필드에 의존성 주입
	@Autowired
	...
	// completeCount 값을 DB에서 조회해서 그래도 반환
	// -> 값(Data)만 응답하길 원한	
	@ResponseBody
...
//		@RequestParam("todoContent") String todoContent
	...
	public int changeCompleteBtn (@RequestBody Todo todo) {
		
			return service.todoChange(todo);
