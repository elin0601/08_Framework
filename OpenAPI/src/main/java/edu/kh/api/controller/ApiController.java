...
public class ApiController {
	...
	public String ex2(
		...
		String serviceKey ="lIH66KzXaSQkB%2FWf3abVrY7DtIes9ltY0OHT0X%2FUwGgxf4lcNgWvxpwieVKCx%2BO%2FLBsDn1UlSlwvyN5clkML4A%3D%3D";
		...
		StringBuilder urlBuilder = new StringBuilder("https://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getUltraSrtFcst"); /*URL*/
        ...
        // 위에서 조합한 요청주소+쿼리스크링 문자열로 
        // 요청을 보낼 수 있는 형태의 객체로 변환
        URL url = new URL(urlBuilder.toString());
        
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        conn.setRequestMethod("GET"); // 요청 매서드 GET
        ...
        // 응답 상태코드가 200~300번대인 경우 (요청/응답 성공인 경우)
        if(conn.getResponseCode() >= 200 && conn.getResponseCode() <= 300) {
        	
        	// InputStreamReader : 바이트 기반 입력 스트임을 문자 기반으로 변경
        	
        	// 문자 형태로 빨리 입력 받기 위한 데이터 (응답 데이터 빨리 받기)
        ...
        // JSON Object : Spring에서 제공하는 JSON 다루기 객체
        ...
        // 현재 시간으로 부터 가장 가까운 시간대 데이터 얻어오기
