...
@Slf4j // lombok  라이브러리가 제공하는 로그 자동생성 어노테이션
public class ExampleController {
	...
	public String ex1(HttpServletRequest req, Model model) {
		...
		stdList.add(new Student("3333", "박삼번", 23));
	
		model.addAttribute("stdList", stdList);
		
		
		return "example/ex1"; // classpath:/templates/example/ex1.html 요청 위임
	}
	
	
	
	
	@PostMapping("ex2") // /example/ex2 POST 방식으로 매핑
