...
public class MemberServiceImpl implements MemberService {
	...
	public int signup(Member inputMember, String[] memberAddress) {
		...
		// 회원 가입 메서드 호출
		// -> MyBatis에 의해서 자동으로 SQL 수행
		//    (메퍼 메서드 호출 시 SQL에 사용할 파라미터는 1개만 전달 가능)
 ...
 *  -> 암호화 할 때 마다 결과가 다름
 *  
 * ex) 1234 입력 	 -> $12dfsdfds
 * ex) 1234 다시입력 -> $12dregghd
 * 
 * - 비밀번호 확인 방법
 ...
 * 		아니면 false 반환
 * 
 *  * 로그인 / 비밀번호 변경 / 탈퇴 증 비밀번호가 입력되는 경우
