...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const params = new URLSearchParams(location.search) /* ex) ?cn=100&key=t 라면 100만 가져옴 */
    const targetId = "c" +  params.get("cn"); /* ex) c13, c16 */
    ...
    if (targetElement) {
        ...
        window.scrollTo({
            top: scrollPosition - 200, /* 스크롤 됐을 때 위에서 200px 떨어진 위치에서 보여줌 */
            behavior: 'smooth'
        });
    }
})
