...
@Slf4j // log를 이용한 메시지 출력 시 사용(Lombok 제공) : 눈에 보이지 않는 코드를 자동 제공해주는 역할
public class ParameterController {
	...
	// HttpServletRequest : 
	// - 요청 클라이언트 정보, 제출된 파라미터 등을 저장 한 객체
	// - 클라이언트 요청 시 생성

	
	/* Spring의 Controller 메서드 작성 시
	 * 매개 변수에 원하는 객체를 작성하면
	 * 존재하는 객체를 바인딩(묶거나) 또는 없으면 생성해서 바인딩(묶거나)
	 * 
	...
	public String paramTest3 (
		...
		// -> 문제점 : Key(name 속성값)이 중복되면 덮어 쓰기가 된다!!
